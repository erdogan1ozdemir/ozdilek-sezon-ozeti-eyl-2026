# Özdilekteyim · Aylık Arama Talebi Insight'ları

Aylık arama talebi görünümü: yükselen başlıklar, mevsimsel keskinlik sıralaması,
Google Trends haftalık seyri, Kat 2 kırılımında kategori profili ve katalog dışı marka fırsatları.

## Aylar

| Ay | Sayfa | Yükselen başlık | Trends kapsamı | Trends son haftası | Durum |
|---|---|---|---|---|---|
...
| Aralık 2026 | `aralik/index.html` | 193 | 193 / 193 | 13-19 Eyl 2026 | Haftalık güncelleniyor |

Her ayın Excel dosyası kendi klasöründedir (`ozdilekteyim-<ay>-2026-arama-talebi.xlsx`); Eylül kök dizindedir.
Aylar sayfanın üst kısmındaki sekmelerden birbirine bağlıdır.
...
- **İçinde bulunulan ay ve sonrası** (Eylül-Aralık) ortak pencereyi paylaşır ve her hafta
  ...
  sabitlenmiş ölçümü olur.
- 0-100 ölçeği her başlığın kendi penceresindeki zirvesine göredir. Farklı pencerelerdeki
  aylar arasında değer kıyası yapılmaz.

**Kaynaklar**
- Google Keyword Planner · Türkiye · aylık arama hacmi · 2024 ve 2025 takvim yılları
- Google Trends · haftalık arama ilgisi · 53 haftalık pencere

Her ayın tüm tabloları ve terim sözlüğü ilgili Excel dosyasında yer almaktadır.

Tek dosyalık statik sayfalar. Harici bağımlılık, script kaynağı veya izleme kodu yoktur.

Bu sayfalar web sürümüdür. Aynı içeriğin e-posta gövdesine yapıştırılmak üzere
